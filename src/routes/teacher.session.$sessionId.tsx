      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-milk border-2 border-ink rounded-2xl p-4 md:p-6 shadow-comic flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="bg-white border-2 border-ink rounded-xl px-4 py-2 shadow-comic-sm flex items-center gap-2">
              <Users className="w-5 h-5 text-ink" />
              <span className="font-bold text-lg">{studentCount ?? 0}</span>
            </div>
            <button
